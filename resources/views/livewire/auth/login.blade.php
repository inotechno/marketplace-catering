            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <div>
                            <p>Don't have an account ? <a href="{{route('register.customer')}}" class="fw-medium text-primary">
                                    Customer Signup </a> or <a href="{{route('register.merchant')}}" class="fw-medium text-primary"> Merchant Signup </a> </p>
                            <p>©{{$year}} Catering. Crafted with <i
