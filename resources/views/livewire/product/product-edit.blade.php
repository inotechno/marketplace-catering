<div>
    @livewire('component.page.breadcrumb', ['breadcrumbs' => [['name' => 'Product', 'url' => '/'], ['name' => 'Edit', 'url' => '/product/creeditate']]])

    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form wire:submit.prevent="update" class="needs-validation form-horizontal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 d-flex mb-3">
                                @foreach ($product_images as $image)
                                    <img src="{{ $image->image_url }}" style="width: 100px; height: 100px" class="img-fluid" alt="">
                                @endforeach
                            </div>
